...
.result {
    ...
    &.successBinding {
        .icon {
            background-image:url('http://182.254.192.167:6003/vue/upload/static/vip/succes.png');
        }
    }
    &.errorBinding {
        .icon {
            background-image:url('http://182.254.192.167:6003/vue/upload/static/vip/close.png');
        }
    }
    &.successApply {
        .icon {
